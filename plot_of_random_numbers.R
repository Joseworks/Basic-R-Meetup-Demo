...
plot(x1, type = "o", main = "both overplot", ylab = "", xlab = "") #Overplot is to overwrite the dots.
plot(x1, type = "h", main = "both", ylab = "", xlab = "") ## Soo ..what is a histogram anyways? Open Html graph.
